...
version: ver3.1
language: E (English)
counterpart: full_manuscript_ver3.1_K.md
date: 2026-04-19
target_journal: Thorax (BMJ)
manuscript_type: Original research article
word_count_body: ~3,680
figures: 3 (main) + 1 (supplement)
tables: 3 (main) + 2 (supplement)
changelog: "v3.0 → v3.1 — session_042 review edits. P0-1 Methods primary/comparator hierarchy; P0-2 PM wording 'approximately one third'; P0-3 Disc §1 'ordinal trend driven by lowest-vs-highest'; P1-1 Limitation prodromal biomarker caveat; P1-2 S3 CRP non-significance note; P1-3 §6 bridge (mechanism duality + pack-years parallel lever); P1-4 Summary Box 'What this adds #1' reframed as formal decomposition; P1-5 Supp Table S2 selection-bias check."
---
...
The SGRQ Symptoms domain was designated *a priori* as the primary candidate mediator; pack-years, SGRQ Activity, and SGRQ Impacts served as prespecified comparator mediators. All four were measured at baseline:
