...
version: ver3.2
language: E (English)
counterpart: full_manuscript_ver3.2_K.md (pending)
date: 2026-04-19
...
changelog: "v3.1 → v3.2 — session_042 2nd-pass review edits. R-1 §3 S3 CRP sentence rewritten (removed 'residual confounding by systemic inflammation'); R-2 §6 Policy paragraph restructured thesis-first with bridge relocated; R-3 'parallel, not substitute, lever' → 'alongside symptom-level care navigation rather than in its place'. v3.0 → v3.1 edits archived in ver3.1_E."
---
