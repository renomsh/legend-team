...
backup_journal: Respiratory Research
language: British English
word_count_target: ~1,355 (Discussion body + Conclusion)
changelog: "v2.1 → v2.2 — session_042 review edits (P0-2, P0-3, P1-1, P1-2, P1-3, P1-4). See full_manuscript_ver3.1_E.md for full changelog."
---

# Editor — Phase 6 Discussion Draft (Thorax-tuned, English) — ver2.2

## Summary Box (Thorax required)
...
Under either mechanistic interpretation considered above, the downstream processes through which educational disadvantage is expressed as excess symptom experience remain the actionable layer for intervention, and the absence of pack-years mediation reflects a weak mediator–outcome link within this analytic sample rather than the absence of an exposure–smoking association; conventional tobacco-control measures therefore remain indicated as a parallel, not substitute, lever. Within a universal-coverage system, a 42% higher exacerbation risk in the lowest education tier — approximately one third of which is channelled through patient-perceived symptom burden — points away from access expansion as the principal lever and towards symptom-level care navigation as the operative deficit. Three practice-relevant implications follow. First, the routine incorporation of patient-reported symptom instruments such as the SGRQ or the COPD Assessment Test into outpatient encounters may be particularly valuable for patients with lower educational attainment, consistent with emerging evidence that multidimensional assessment improves identification of those at elevated exacerbation risk.[Bhatt 2025 JAMA] Second, chronic disease management programmes and pulmonary rehabilitation, which have demonstrated benefits for exercise capacity, symptom burden and readmission in COPD,[Lamberton 2024 Respir Care] but which remain markedly under-utilised, may yield greater population-level benefit if prioritised towards patients with lower educational attainment; the feasibility of scalable, less resource-intensive delivery — through telerehabilitation and digital self-management programmes — has strengthened the case for such differential allocation.[Cox 2022 Thorax; Gloeckl 2025 Thorax] Third, because education itself is not a proximal target, interventions should focus on the downstream processes of symptom literacy, early-deterioration recognition and self-management behaviour. These recommendations are hypothesis-generating and require confirmation in implementation trials; nevertheless, addressing how patients with lower educational attainment experience and report symptoms, rather than merely whether they reach care, may be the higher-yield lever in universal-coverage COPD systems.
...
## Cover letter paragraph (for editor) — unchanged from ver2.1

> Within the KOCOSS cohort, prior analyses have characterised phenotypic subgroups, including chronic bronchitis definitions, eosinophilic exacerbation risk, progression to frequent-exacerbator status, and ten-year mortality. The present study is, to our knowledge, the first to decompose the socioeconomic gradient in one-year COPD or PRISm exacerbation risk into mediated and direct components through formal causal mediation analysis, identifying patient-perceived symptom burden — as captured by the SGRQ Symptoms domain — as the sole operative intermediate pathway. The finding emerges within a universal-coverage national health insurance system, positioning symptom-level care navigation as a candidate policy lever distinct from access expansion, and — we believe — of direct relevance to Thorax's readership.

---

## Diff audit — v2.1 → v2.2

| ID | Section | Change |
|---|---|---|
| P0-2 | Summary Box / Conclusion | "35.8%" → "approximately one third" in Summary Box "What this adds #2" and Conclusion (kept the numeric value only in Discussion §1 with caveat) |
| P0-3 | Discussion §1 | "monotonic trend" → "ordinal trend … driven primarily by the contrast between the lowest and highest tiers" |
| P1-1 | Limitations (3rd) | Added "; residual prodromal contribution cannot be excluded in the absence of biomarker-based pre-exacerbation staging" |
| P1-2 | Discussion §3 (Mechanism) | Added sentence on S3 CRP non-significance (residual confounding vs reduced power) |
| P1-3 | Implications §6 (opening) | Bridge sentence: "Under either mechanistic interpretation … pack-years … parallel, not substitute, lever" |
| P1-4 | Summary Box "What this adds #1" | Reframed as "formal causal decomposition … total-effect OR 1.42" |
| P1-5 | Limitations (1st) | Appended "baseline characteristics of the analysis and excluded sets were broadly comparable (Supplementary Table S2)" |

## Word count (Discussion body only)

- ¶1 Principal findings: ~185 words
- ¶2 Comparison: ~170 words
- ¶3 Mechanism: ~290 words (+ S3 CRP sentence)
- ¶4 Strengths: ~85 words
- ¶5 Limitations: ~235 words (+ prodromal + SuppTable S2 clauses)
- ¶6 Policy: ~320 words (+ bridge opening)
- Conclusion: ~100 words

**Total**: ~1,385 words (Discussion body + Conclusion). Within Thorax 1,500-word envelope.

## Reference list — unchanged from ver2.1 (see full_manuscript_ver3.1_E.md for authoritative copy)
