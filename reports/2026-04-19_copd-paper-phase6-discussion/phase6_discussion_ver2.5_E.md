...
references_added_in_discussion: 9 (Gershon, Prescott, Hurst, Divo, Nutbeam, Berkman, Effing [§6 anchor], Jones, Kessler, Spruit, Bourne)
changelog: "v2.4 → v2.5 — convergence with full_manuscript_ver3.4. F-7 Effing 2016 moved from §3 to §6 'self-management behaviour' anchor. Discussion body otherwise unchanged. Authoritative 36-entry reference list maintained in full_manuscript_ver3.4_E.md."
---

# Editor — Phase 6 Discussion Draft (Thorax-tuned, English) — ver2.5
