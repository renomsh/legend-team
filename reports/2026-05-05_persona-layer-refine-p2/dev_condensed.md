### Condense — dev (원본: dev_rev1.md)
- 제거: 없음 (원본 lean — diff + 검증만)
- 보존: 변경 diff · 근거 · 검증 수치 · Self-Score
...
## 근거
강제 제약 § line 114가 enforcement 형태로 동일 정보 cover. line 130(actionable) 보존 (Riki 권고).
