...
exports.ContextLayerError = void 0;
exports.validateTurnLogEntry = validateTurnLogEntry;
exports.validateSessionContributionFM = validateSessionContributionFM;
exports.validateL2Body = validateL2Body;
exports.validateContextBriefFM = validateContextBriefFM;
exports.validateL3Body = validateL3Body;
const context_layers_1 = require("../../src/types/context-layers");
// ──────────────────────────────────────────
// 공통
// ──────────────────────────────────────────
class ContextLayerError extends Error {
    layer;
...
exports.ContextLayerError = ContextLayerError;
function assertString(v, field, layer) {
...
// L1 TurnLogEntry
// ──────────────────────────────────────────
function validateTurnLogEntry(obj, ctx) {
    ...
    if (ctx?.expectedTopicId && topicId !== ctx.expectedTopicId) {
        throw new ContextLayerError('L1', `topicId 불일치: entry="${topicId}" vs expected="${ctx.expectedTopicId}" — 토픽 경계 오염 의심`);
    }
    return e;
}
// ──────────────────────────────────────────
...
// ──────────────────────────────────────────
function validateSessionContributionFM(obj) {
    if (!obj || typeof obj !== 'object') {
    ...
    if (typeof nextAction !== 'string' || nextAction.trim().length === 0) {
        throw new ContextLayerError('L2', 'nextAction 누락 — Ace 종합검토에서 생성 필수 (quality 플래그 오염 원인)');
    }
    return f;
}
/** L2 Markdown 본문에 필수 섹션이 모두 있는지 검증 */
function validateL2Body(md) {
...
// L3 ContextBrief
// ──────────────────────────────────────────
function validateContextBriefFM(obj) {
    if (!obj || typeof obj !== 'object') {
    ...
    if (f['sizeBytes'] > context_layers_1.L3_SIZE_LIMIT_BYTES) {
        throw new ContextLayerError('L3', `sizeBytes=${f['sizeBytes']} > ${context_layers_1.L3_SIZE_LIMIT_BYTES} — 상한 초과, Editor 요약 압축 필요`);
    }
    return f;
}
function validateL3Body(md) {
...
//# sourceMappingURL=validate-context-layers.js.map