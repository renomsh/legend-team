...
function main() {
    ...
    if (!topicId || !topicType) {
        console.error('Usage: npx ts-node scripts/reclassify-topic.ts <topicId> <framing|implementation|standalone> [parentTopicId]');
        process.exit(1);
    }
...
main();
//# sourceMappingURL=reclassify-topic.js.map