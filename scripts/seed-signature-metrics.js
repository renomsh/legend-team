...
function base(id, shortKey, role, axis, scale, polarity, construct, externalAnchor, overrides = {}) {
    return {
...
function participationByRole(role) {
    switch (role) {
...
//# sourceMappingURL=seed-signature-metrics.js.map